<div class="container mt-5">
    ...
    foreach($lesContinents as $continent){
        ...
        echo "<td class='col-md-2'>
            ...
            <a href='#modalSuppression' data-toggle='modal' data-message='Voulez vous supprimer ce continent ?' data-suppression='index.php?uc=nationalites&action=delete&num=".$continent->getNum()."' class='btn btn-danger'><i class='far fa-trash-alt'></i></a>
        </td>";
        echo "</tr>";
    }
